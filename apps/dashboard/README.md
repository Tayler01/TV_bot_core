...
- shared dashboard primitives plus extracted monitoring, control-center, and safety-review components so the redesign is no longer trapped inside one oversized `App.tsx`
