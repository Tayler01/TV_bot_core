...
1. Build the actual dashboard live contract-chart renderer and overlay UX on top of the new chart control-plane foundation tracked in `docs/architecture/dashboard_live_chart_plan.md`.
...
- Live contract chart renderer in `apps/dashboard` backed only by the local control plane
