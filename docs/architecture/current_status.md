...
1. Finish the remaining dashboard chart polish on top of the live contract-chart renderer tracked in `docs/architecture/dashboard_live_chart_plan.md`, especially degraded/reconnect chart states and final operator ergonomics.
...
- Final live contract-chart polish in `apps/dashboard`, including degraded/reconnect chart-state treatment and final operator ergonomics now that fit/live-follow controls and precise working-order prices are in place
