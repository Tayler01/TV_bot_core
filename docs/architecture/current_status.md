...
1. Finish final dashboard chart/operator production sign-off on top of the live contract-chart renderer tracked in `docs/architecture/dashboard_live_chart_plan.md`, including last browser QA and operator ergonomics review.
...
- Final live contract-chart production sign-off in `apps/dashboard`, including last browser QA and operator ergonomics review now that fit/live-follow controls, precise working-order prices, chart-state banners, and chart readout strips are in place
