...
The current provider-and-project integration audit now lives in `docs/architecture/integration_audit_2026-04-17.md`, with follow-up operator docs in `docs/ops/credential_setup.md`, `docs/ops/cli_standalone.md`, `docs/ops/debugging_guide.md`, and `strategies/docs/authoring.md`.
